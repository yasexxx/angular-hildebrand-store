...
export class SupermarketComponent implements OnInit {
  ...
  supermarketBg: string| ArrayBuffer;
  ...
  subsAsset(){
    this.subscriptionAsset = this.asset.getAssetToCache('assets/images/supermarket.webp').subscribe(
      data => { this.supermarketBg = data.result; }
    )
  }
